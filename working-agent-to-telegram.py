...
prompt = ContextPrompt(
    context="This is information generated by google clound video intelligence."
                ...
                "You must give only one word in the output. Output only True if they likely fell off the bike during the video and only False "
                "otherwise. Do not state your reasoning.\n\n",
    text=transcript,
)
